        ...
        foreach($dadosJogos as $dados) {
          ?>
            <div class="col-12 col-md-3">
              <div class="card">
                <img src="<?=$dados->creatorImg?>" alt="<?=$dados->creatorName?>" class="card-img-top" id="card">
                <div class="card-body text-center">
                  <p class="text-uppercase active"><?=$dados->creatorName?></p>
                  <p class="text-uppercase active"><?=$dados->creatorFormation?></p>
                </div>
              </div>
            </div>
          <?php
