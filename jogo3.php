...
<body>
  ...
  <div class="banner">
    <img src="https://vaporstoresite.000webhostapp.com/img/banners/tommyAdventure/banner01.jpg" class="w-100">
  </div>
  <div class="text-center text-uppercase">
    <h1>Tommy Adventure</h1>
    <p>O jogo de plataforma Tommy's Adventure é inspirado em jogos estilo Endless Runner que são jogos de corrida<br>
      intermináveis, como exemplo o Dino T-Rex, o famoso dinossauro do Google que aparece quando a internet cai.<br>No
      Tommy's Adventure, o jogador iniciará a partida já em movimento e deverá seguir a diante tomando cuidado com os<br>
      obstáculos e trajetos incompletos que implicarão direto no resultado do jogo.</p>
  </div>
  <div class="text-center text-uppercase">
    <h1>Fotos do Game</h1>
    <div class="container">
      <div class="row">
        <div class="col-12 col-md-3">
          <img src="https://vaporstoresite.000webhostapp.com/img/banners/tommyAdventure/screenshot01.jpg"
            class="card-img-top">
        </div>
        <div class="col-12 col-md-3">
          <img src="https://vaporstoresite.000webhostapp.com/img/banners/tommyAdventure/screenshot02.jpg"
            class="card-img-top">
        </div>
        <div class="col-12 col-md-3">
          <img src="https://vaporstoresite.000webhostapp.com/img/banners/tommyAdventure/screenshot03.jpg"
            class="card-img-top">
        </div>
        <div class="col-12 col-md-3">
          <img src="https://vaporstoresite.000webhostapp.com/img/banners/tommyAdventure/screenshot04.jpg"
            class="card-img-top">
        </div>
      </div>
    </div>
